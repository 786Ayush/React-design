...
const BigCard = () => {
  return (
    <div className="p-2 w-[87vw] h-fit">
      <div className="upper  p-7 bg-[#15132B] rounded-[14px]">
        <div className="flex flex-row justify-between">
          <div className="flex flex-row items-center">
            ...
            <div className="content p-3">
              <div className="text-white">School November Tasks</div>
              <div className="text-[#A5A5A5]">
                Created by Ayush Gupta on November 31, 2022
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-row items-center">
            <div className="content p-3">
              <div className="text-white">Centered Martial Arts</div>
              <div className="text-[#A5A5A5] text-end">Sunnywale, Ca</div>
            </div>
            <div className="icon bg-white p-2 rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="44"
                height="44"
        ...
        <div className="flex flex-row ">
          <div className="relative flex flex-row justify-stretch">
            <div className="w-fit">
              <div className="icons relative">
                <div className="circle bg-[#C4C4C4] absolute rounded-full w-10 h-10 border-2 p-1  text-center items-center  border-[#15132B]"></div>
                <div className="circle bg-[#C4C4C4] absolute left-6 z-1 outline-1 outline-white rounded-full w-10 h-10 border-2 p-1  text-center items-center  border-[#15132B]"></div>
                <div className="circle bg-[#C4C4C4] absolute left-12 z-2 rounded-full w-10 h-10 border-2 p-1  text-center items-center  border-[#15132B]"></div>
                <div className="circle bg-[#C4C4C4] absolute left-[4.5rem] z-2 rounded-full w-10 h-10 border-2 p-1  text-center  border-[#15132B] items-center"></div>
                <div className="circle bg-[#E328AF] text-white absolute left-[6rem] z-3 rounded-full w-10 h-10 border-2 p-1 border-[#15132B]  text-center items-center">
                  5+
                </div>
              </div>
            </div>
            <div className="btn p-2 left-28 w-fit relative bg-[#6418C3] rounded-[14px] flex flex-row p-1 mx-10 items-center">
              <div className="icon ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
              ...
              <div className="content text-white">Invite People</div>
            </div>
          </div>
          <div className="btn w-fit relative left-24 p-3 font-bold border-[#6418C3] border-2 text-centert text-white rounded-xl">
            Private
          </div>
          <div className="btn w-fit relative left-28 p-4 font-bold bg-[#6418C3] text-center rounded-xl text-white">
            Edit
          </div>
          <div className="btn relative left-32 flex flex-row p-2 text-center border-[#6418C3] border-2 rounded-xl">
            ...
            <div className="content p-2 text-white">45 Comments</div>
          </div>
          <div className="absolute right-0 flex flex-row text-center justify-center">
            <div className="content text-white p-2">Total Progress 60%</div>
            <div className="loader p-5">
              <div className="w-[200px] bg-[#1E1C3A] rounded-full h-2.5 mb-4 dark:bg-gray-700">
                <div className="bg-[#6418C3] h-2.5 rounded-full dark:bg-gray-300 w-3/5"></div>
              </div>
            </div>
          </div>
        </div>
